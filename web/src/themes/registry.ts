...
export const SCENES: Record<string, { title: string; blurb: string; accent: string }> = {
  ...
  gibson: { title: 'The Gibson', blurb: 'The storage wall from the movie: smoked-glass towers edged in glowing white, a DHCP lease writes a new one, and the camera locks onto red intruder files.', accent: '#9fd8ff' },
};
